 ...
 * @version $Id: WftSpTradeRefundQueryResp.java, v 0.1 2017年7月5日 下午1:25:52 song.li@witontek.com Exp $
 */
@XmlRootElement(name = "xml")
@XmlAccessorType(XmlAccessType.FIELD)
public class WftSpTradeRefundQueryResp extends AbstractSpResp {

    /**  */
    private static final long serialVersionUID = -238963804859208107L;
