...
public class SpTradeRefundQueryReq extends AbstractRequest {
    ...
    @XmlElement(name = "wt_refund_no")
    private String            wtRefundNo;
    ...
    /**
     * Getter method for property <tt>wtRefundNo</tt>.
     * 
     * @return property value of wtRefundNo
     */
    public String getWtRefundNo() {
        return wtRefundNo;
    }

    /**
     * Setter method for property <tt>wtRefundNo</tt>.
     * 
     * @param wtRefundNo value to be assigned to property wtRefundNo
     */
    public void setWtRefundNo(String wtRefundNo) {
        this.wtRefundNo = wtRefundNo;
    }
